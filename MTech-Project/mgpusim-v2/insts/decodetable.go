...
func (d *Disassembler) initializeDecodeTable() {
	...
	d.addInstType(&InstType{"v_subbrev_u32_e32", 30, FormatTable[VOP2], 0, ExeUnitVALU, 32, 32, 32, 0, 0})
	...
	d.addInstType(&InstType{"v_cmp_ne_u64_e32", 0xed, FormatTable[VOPC], 0, ExeUnitVALU, 32, 64, 64, 0, 0})
	...
	d.addInstType(&InstType{"v_cmp_ne_u64_e32", 0xed, FormatTable[VOP3a], 0, ExeUnitVALU, 64, 64, 64, 0, 0})
