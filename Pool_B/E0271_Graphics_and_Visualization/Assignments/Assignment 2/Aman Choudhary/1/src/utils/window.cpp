...
extern bool rotateLight, rotateObject;
extern float lightRotationAngle, objectRotationAngle;
...
void onAlphaNumericKeyPress(unsigned char key, int x, int y)
{
	...
	/* reset */
	case 'r':
		rotateLight = rotateObject = false;
		objectRotationAngle = lightRotationAngle = 0.0f;
		break;
